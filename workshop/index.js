...
console.log(lessthan100(83,44));//false
console.log(lessthan100(12,66));//true
...
function main(x,y){
    if (y>x && x>=0 && y>=0){
        count=0;
        while (x<=y){
            if (primeInRange(x)==true && x!=0 && x!=1 ){
                count=count+1;
            }
            x=x+1;
        }
